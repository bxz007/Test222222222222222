...
namespace GameMain
{
    public static class EntityExtension
    {
        ...
        public static void ShowUser(this EntityComponent entityComponent,UserData data )
        {
            entityComponent.ShowEntity(typeof(User), "User", Constant.AssetPriority.MyAircraftAsset, data);
        }
